"""
Screenshot vision ingestion pipeline.

Iterates over product screenshot directories, sends each image to GPT-4o
Vision for detailed UX analysis, and upserts the resulting description
chunks into the pm_tools ChromaDB collection for downstream RAG retrieval.

Skips screenshots already present in the collection (keyed by filename
metadata), so re-running is safe and idempotent.

Usage:
    python -m ingestion.screenshot_vision_ingest
"""
