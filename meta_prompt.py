...
def generate_personas(product_description: str, llm: LLM) -> list[dict]:
    """Run the meta-prompt to generate 3 dynamic personas for the given product."""
    ...
    try:
        ...
        print(f"Warning: Failed to parse personas JSON: {e}")
