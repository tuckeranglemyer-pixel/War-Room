...
def built_crew():
    ...
    with (
        ...
        patch("src.orchestration.adversarial_debate_engine.fetch_context_for_product", return_value="[mock evidence]"),
    ):
...
def test_config_defines_two_distinct_model_identifiers_for_current_dev_environment():
    ...
    from src.inference.model_config import DAILY_DRIVER_BUYER_MODEL, LOCAL_MODEL
...
def test_api_port_does_not_conflict_with_vllm_model_ports():
    ...
    from src.inference.model_config import API_PORT
