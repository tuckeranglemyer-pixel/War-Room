...
from .settings import LOCAL_BASE_URL, LOCAL_MODEL, MAX_SCOUTS, MAX_WORKERS
from .persona_generator import generate_personas
from .scout_swarm import deploy_swarm
from .chroma_rag_tools import (
    fetch_context_for_product,
    search_pm_knowledge,
)

# --- LLM configuration (see settings.py; swap models on DGX via env or config) ---
# DGX production example (commented in settings.py):
