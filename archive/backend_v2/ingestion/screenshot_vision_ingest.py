...
NOTE: DATA_DIR is hardcoded to a local path. Update this before running on
a different machine, or set the DATA_DIR environment variable.
"""
...
DATA_DIR = Path(os.environ.get("SCREENSHOT_DATA_DIR", r"C:\Users\griff\Downloads\hackathon-data-toolkit\data-toolkit\data"))
